...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner SharedVolume
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &efscsiv1alpha1.SharedVolume{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSharedVolume) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &efscsiv1alpha1.SharedVolume{}
	...
	// Set SharedVolume instance as the owner and controller
...
func newPodForCR(cr *efscsiv1alpha1.SharedVolume) *corev1.Pod {
